...
export const snowballRService: ISnowballR = {
    ...
    resetPassword: function (
        call: ServerUnaryCall<PasswordResetRequest, Nothing>,
        callback: sendUnaryData<Nothing>,
    ): void {
        throw new Error("Function not implemented.");
    },
    ...
    getAllUsers: function (
        call: ServerUnaryCall<Nothing, User_List>,
    ...
    getAllProjects: function (
        call: ServerUnaryCall<Nothing, Project_List>,
        callback: sendUnaryData<Project_List>,
    ): void {
        throw new Error("Function not implemented.");
    },
    ...
    exportProject: function (
        call: ServerUnaryCall<ExportRequest, Blob>,
    ...
    getForwardReferencedPapers: function (
        call: ServerUnaryCall<Id, Paper_List>,
        callback: sendUnaryData<Paper_List>,
    ): void {
        throw new Error("Function not implemented.");
    },
